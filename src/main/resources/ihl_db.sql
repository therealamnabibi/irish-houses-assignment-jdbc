...
(1, 'Sue Roberts', '061 451890', '061 451880', 'sue@ihl.ie', 'Sue.Roberts', 'suepass'),
(2, 'Natasha Watkins', '061 451891', '061 451881', 'natasha@ihl.ie', 'Natasha.Watkins', 'natashapass'),
(3, 'Chris Clarkson', '061 451892', '061 451882', 'chris@ihl.ie', 'Chris.Clarkson', 'chrispass'),
(4, 'Laura Blain', '061 451893', '061 451883', 'laura@ihl.ie', 'Laura.Blain', 'laurapass'),
(5, 'Dave Lindale', '061 451894', '061 451884', 'dave@ihl.ie', 'Dave.Lindale', 'davepass');
...
ALTER TABLE `properties`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_styleId` (`styleId`),
  ADD KEY `fk_typeId` (`typeId`),
  ADD KEY `fk_garageId` (`garageId`),
...
--
ALTER TABLE `properties`
  ADD CONSTRAINT `fk_properties_agents` FOREIGN KEY (`agentId`) REFERENCES `agents` (`agentId`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_properties_garagetypes` FOREIGN KEY (`garageId`) REFERENCES `garagetypes` (`garageId`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_properties_propertytypes` FOREIGN KEY (`typeId`) REFERENCES `propertytypes` (`typeId`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_properties_styles` FOREIGN KEY (`styleId`) REFERENCES `styles` (`styleId`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
